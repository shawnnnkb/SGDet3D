...
class TJ4DDataset(Custom3DDataset):
    r"""KITTI Dataset.
    ...
    def get_data_info(self, index):
        ...
        P2 = info['calib']['P2'].astype(np.float32) # cam2img
        lidar2img = P2 @ rect @ Trv2c
        lidar2cam = rect @ Trv2c
        cam2img = P2
        # assert P2 @ lidar2cam == lidar2img
        
        # add focal length (CAM2 aware) and baseline (stereo aware)
    ...
    def dynamic_baseline(self, info):
        P2 = np.array(info['calib']['P2'].astype(np.float32)) # cam2img
    ...
    def get_ann_info(self, index):
        ...
        # assert len(gt_bboxes_3d) == len(gt_labels)
